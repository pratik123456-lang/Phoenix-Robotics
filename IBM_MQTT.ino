...
const char* ssid = "ANDRIOD 540";
const char* password = "tiger300";

#define ORG "6wf2td"
#define DEVICE_TYPE "NODEMCU"
#define DEVICE_ID "ESP8266-20"
#define TOKEN "aOCM9rS*7YiOfrqn78"
...
void handleUpdate(byte* payload) {
 ...
 Serial.println("handleUpdate payload:"); serializeJsonPretty(Doc,Serial); Serial.println();
